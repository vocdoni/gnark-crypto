...
// q (modulus)
const qElementWord0 uint64 = 16657056631097876523
const qElementWord1 uint64 = 55
...
const qInvNegLsw uint64 = 3679285146481172861
...
func (z *Element) SetInterface(i1 interface{}) (*Element, error) {
	...
	case *Element:
		if c1 == nil {
			return nil, errors.New("can't set little.Element with <nil>")
		}
		return z.Set(c1), nil
	case uint8:
	...
	default:
		return nil, errors.New("can't set little.Element from type " + reflect.TypeOf(i1).String())
	}
}
...
func (z *Element) IsOne() bool {
	return (z[1] ^ 10 | z[0] ^ 14831352495647895042) == 0
}
...
func (z *Element) LexicographicallyLargest() bool {
	...
	var b uint64
	_, b = bits.Sub64(_z[0], 17551900352403714070, 0)
	_, b = bits.Sub64(_z[1], 27, b)
...
func (z *Element) SetRandom() (*Element, error) {
	...
	if !(z[1] < 55 || (z[1] == 55 && (z[0] < 16657056631097876523))) {
		var b uint64
		z[0], b = bits.Sub64(z[0], 16657056631097876523, 0)
		z[1], _ = bits.Sub64(z[1], 55, b)
	}
...
func (z *Element) Halve() {
	if z[0]&1 == 1 {
		...
		// z = z + q
		z[0], carry = bits.Add64(z[0], 16657056631097876523, 0)
		z[1], _ = bits.Add64(z[1], 55, carry)
...
func _mulGeneric(z, x, y *Element) {
	...
	var c [3]uint64
	{
		...
		m := c[0] * 3679285146481172861
		c[2] = madd0(m, 16657056631097876523, c[0])
		c[1], c[0] = madd1(v, y[1], c[1])
		t[1], t[0] = madd3(m, 55, c[0], c[2], c[1])
	}
	{
		// round 1
		v := x[1]
		...
		z[1], z[0] = madd3(m, 55, c[0], c[2], c[1])
	}
...
func _mulWGeneric(z, x *Element, y uint64) {
	...
	var t [2]uint64
	{
		...
		m := c0 * 3679285146481172861
		c2 := madd0(m, 16657056631097876523, c0)
		c1, c0 = madd1(y, x[1], c1)
		t[1], t[0] = madd3(m, 55, c0, c2, c1)
	}
	{
		// round 1
		m := t[0] * 3679285146481172861
		c2 := madd0(m, 16657056631097876523, t[0])
		z[1], z[0] = madd2(m, 55, t[1], c2)
	}
...
func _fromMontGeneric(z *Element) {
	...
	{
		// m = z[0]n'[0] mod W
		m := z[0] * 3679285146481172861
		C := madd0(m, 16657056631097876523, z[0])
		C, z[0] = madd2(m, 55, z[1], C)
		z[1] = C
	}
	{
		// m = z[0]n'[0] mod W
...
func _subGeneric(z, x, y *Element) {
	...
	if b != 0 {
		var c uint64
		z[0], c = bits.Add64(z[0], 16657056631097876523, 0)
		z[1], _ = bits.Add64(z[1], 55, c)
	}
}
...
func _negGeneric(z, x *Element) {
	...
	var borrow uint64
	z[0], borrow = bits.Sub64(16657056631097876523, x[0], 0)
	z[1], _ = bits.Sub64(55, x[1], borrow)
}
...
func init() {
	_bLegendreExponentElement, _ = new(big.Int).SetString("1bf394e0606613b015", 16)
	const sqrtExponentElement = "df9ca70303309d80b"
...
func (z *Element) Legendre() int {
	...
	// if l == 1
	if (l[1] == 10) && (l[0] == 14831352495647895042) {
		return 1
	}
	return -1
}
...
const inversionCorrectionFactorWord0 = 11406159648050240538
const inversionCorrectionFactorWord1 = 36

const invIterationsN = 6
...
func (z *Element) montReduceSigned(x *Element, xHi uint64) {
	...
	// <standard SOS>
	{
		...
		z[1], z[0] = madd2(m, qElementWord1, t[i+1], C)
	}
	...
	if neg {
		...
		if b != 0 {
			...
			z[1], _ = bits.Add64(neg1, qElementWord1, b)
		}
	}
}
