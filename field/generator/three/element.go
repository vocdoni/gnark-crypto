...
// Element represents a field element stored on 3 words (uint64)
// Element are assumed to be in Montgomery form in all methods
// field modulus q =
//
// 1223566544571693215011093711131306797387
type Element [3]uint64
...
// q (modulus)
const qElementWord0 uint64 = 5004131540414146891
const qElementWord1 uint64 = 10989443069131923958
const qElementWord2 uint64 = 3
...
const qInvNegLsw uint64 = 16838227660570584989

// rSquare
var rSquare = Element{
	10200883021687036495,
	8392961147956355161,
	2,
}
...
func init() {
	_modulus.SetString("1223566544571693215011093711131306797387", 10)
}
...
func (z *Element) SetInterface(i1 interface{}) (*Element, error) {
	...
	case *Element:
		if c1 == nil {
			return nil, errors.New("can't set three.Element with <nil>")
		}
		return z.Set(c1), nil
	case uint8:
	...
	default:
		return nil, errors.New("can't set three.Element from type " + reflect.TypeOf(i1).String())
	}
}
...
func (z *Element) SetOne() *Element {
	z[0] = 5531300217576828755
	z[1] = 9925152879194870921
	z[2] = 0
	return z
}
...
func (z *Element) IsOne() bool {
	return (z[2] ^ 0 | z[1] ^ 9925152879194870921 | z[0] ^ 5531300217576828755) == 0
}
...
func (z *Element) LexicographicallyLargest() bool {
	...
	var b uint64
	_, b = bits.Sub64(_z[0], 2502065770207073446, 0)
	_, b = bits.Sub64(_z[1], 14718093571420737787, b)
...
func (z *Element) SetRandom() (*Element, error) {
	...
	if !(z[2] < 3 || (z[2] == 3 && (z[1] < 10989443069131923958 || (z[1] == 10989443069131923958 && (z[0] < 5004131540414146891))))) {
		var b uint64
		z[0], b = bits.Sub64(z[0], 5004131540414146891, 0)
		z[1], b = bits.Sub64(z[1], 10989443069131923958, b)
...
func (z *Element) Halve() {
	if z[0]&1 == 1 {
		...
		// z = z + q
		z[0], carry = bits.Add64(z[0], 5004131540414146891, 0)
		z[1], carry = bits.Add64(z[1], 10989443069131923958, carry)
...
func _mulGeneric(z, x, y *Element) {
	...
	var c [3]uint64
	{
		...
		m := c[0] * 16838227660570584989
		c[2] = madd0(m, 5004131540414146891, c[0])
		c[1], c[0] = madd1(v, y[1], c[1])
		c[2], t[0] = madd2(m, 10989443069131923958, c[2], c[0])
	...
	}
	{
		...
		c[2] = madd0(m, 5004131540414146891, c[0])
		c[1], c[0] = madd2(v, y[1], c[1], t[1])
		c[2], z[0] = madd2(m, 10989443069131923958, c[2], c[0])
		c[1], c[0] = madd2(v, y[2], c[1], t[2])
...
func _mulWGeneric(z, x *Element, y uint64) {
	...
	var t [3]uint64
	{
		...
		m := c0 * 16838227660570584989
		c2 := madd0(m, 5004131540414146891, c0)
		c1, c0 = madd1(y, x[1], c1)
		c2, t[0] = madd2(m, 10989443069131923958, c2, c0)
		c1, c0 = madd1(y, x[2], c1)
		t[2], t[1] = madd3(m, 3, c0, c2, c1)
	}
	{
		// round 1
		m := t[0] * 16838227660570584989
		c2 := madd0(m, 5004131540414146891, t[0])
		c2, t[0] = madd2(m, 10989443069131923958, c2, t[1])
	...
	}
	{
		...
		m := t[0] * 16838227660570584989
		c2 := madd0(m, 5004131540414146891, t[0])
		c2, z[0] = madd2(m, 10989443069131923958, c2, t[1])
...
func _fromMontGeneric(z *Element) {
	...
	{
		// m = z[0]n'[0] mod W
		m := z[0] * 16838227660570584989
		C := madd0(m, 5004131540414146891, z[0])
		C, z[0] = madd2(m, 10989443069131923958, z[1], C)
...
func _subGeneric(z, x, y *Element) {
	...
	if b != 0 {
		var c uint64
		z[0], c = bits.Add64(z[0], 5004131540414146891, 0)
		z[1], c = bits.Add64(z[1], 10989443069131923958, c)
...
func _negGeneric(z, x *Element) {
	...
	var borrow uint64
	z[0], borrow = bits.Sub64(5004131540414146891, x[0], 0)
	z[1], borrow = bits.Sub64(10989443069131923958, x[1], borrow)
...
func init() {
	_bLegendreExponentElement, _ = new(big.Int).SetString("1cc412c1f977e50fb22b91f8fbddb54a5", 16)
	const sqrtExponentElement = "e620960fcbbf287d915c8fc7deedaa53"
...
func (z *Element) Legendre() int {
	...
	// if l == 1
	if (l[2] == 0) && (l[1] == 9925152879194870921) && (l[0] == 5531300217576828755) {
		return 1
	}
	return -1
}
...
const inversionCorrectionFactorWord0 = 15904005467890798607
const inversionCorrectionFactorWord1 = 3843529456510718262
const inversionCorrectionFactorWord2 = 0

const invIterationsN = 10
...
func (z *Element) montReduceSigned(x *Element, xHi uint64) {
	...
	}
	{
		...
		z[2], z[1] = madd2(m, qElementWord2, t[i+2], C)
	}
	...
	if neg {
		...
		if b != 0 {
			...
			z[2], _ = bits.Add64(neg1, qElementWord2, b)
		}
	}
}
